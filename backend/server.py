...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Kimbalama#32@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Kimbalama#32@localhost")  # No database specified
